...
export const EVAL_DATASET: EvalScenario[] = [
  ...
  {
    scenarioId: 'scen-18',
    name: 'Conversation-only grounding',
    userId: 'user-1',
    query: 'What did we talk about yesterday?',
    maxTokens: 1500,
    isPersonal: true,
    expectedRelevantIds: [],
    expectedResponsePattern: 'PostgreSQL',
    inputMemories: [],
  },
  {
    scenarioId: 'scen-19',
    name: 'Combined sources grounding',
    userId: 'user-1',
    query: 'What tea and tools do I prefer? (combined query)',
    maxTokens: 1500,
    isPersonal: true,
    expectedRelevantIds: ['mem-1'],
    expectedResponsePattern: 'Matcha',
  ...
  {
    scenarioId: 'scen-21',
    name: 'Insufficient-context personal question',
    userId: 'user-1',
    query: 'What is my pet name?',
    maxTokens: 1500,
    isPersonal: true,
    expectedRelevantIds: [],
    expectedResponsePattern: 'do not have any saved memory context',
    inputMemories: [],
  },
  {
    scenarioId: 'scen-22',
    name: 'Citation mismatch query',
    userId: 'user-1',
    query: 'Where do I work? (mismatch query with fake citation)',
    maxTokens: 1500,
    isPersonal: true,
    expectedRelevantIds: [],
    expectedResponsePattern: 'cannot retrieve details',
    inputMemories: [],
  },
];
